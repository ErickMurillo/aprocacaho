...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('area_1', multiselectfield.db.fields.MultiSelectField(choices=[(1, 'Baja fertilidad del suelo'), (2, 'Plagas y enfermedades')], max_length=3, verbose_name='En \xe1reas de 1 a 3 a\xf1os')),
                ('area_2', multiselectfield.db.fields.MultiSelectField(choices=[(1, 'Baja fertilidad del suelo'), (2, '\xc1rboles poco productivos'), (3, 'Plagas y enfermedades'), (4, 'Poca producci\xf3n'), (5, 'Poca disponibilidad/Mano de obra')], max_length=9, verbose_name='En \xe1reas de 4 a 10 a\xf1os')),
                ('area_3', multiselectfield.db.fields.MultiSelectField(choices=[(1, 'Baja fertilidad del suelo'), (2, '\xc1rboles poco productivos'), (3, 'Plantaciones muy viejas'), (4, 'Plagas y enfermedades'), (5, 'Poca producci\xf3n'), (6, 'Poca disponibilidad/Mano de obra')], max_length=11, verbose_name='En \xe1reas de 10 a 20 a\xf1os')),
                ('encuesta', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='productores.Encuesta')),
            ],
            options={
